...
function () {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Camera, [{
    ...
    key: "animate",
    value: function animate() {// this.scene.onPointerObservable.add(pointerInfo => {
...
/*#__PURE__*/
function () {
  function Consciousness(world) {
    Object(_babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, Consciousness);

    this.world = world;
  }

  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Consciousness, [{
    key: "update",
    value: function update() {
      if (_Config__WEBPACK_IMPORTED_MODULE_2__["default"].grid.animated) {
...
function () {
  function Effects(world) {
    ...
    if (_Config__WEBPACK_IMPORTED_MODULE_2__["default"].effects.lens.enabled) {
      this.enableLens();
    }
  }
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Effects, [{
    ...
    value: function createFog() {
      ...
      this.world.scene.fogDensity = _Config__WEBPACK_IMPORTED_MODULE_2__["default"].effects.fog.density;
      this.world.scene.fogColor = _Config__WEBPACK_IMPORTED_MODULE_2__["default"].effects.fog.color;
    }
  }, {
    key: "enableLens",
    value: function enableLens() {// this.lensEffect = new BABYLON.LensRenderingPipeline('lens', {
      //     edge_blur: 1.0,
    ...
    value: function extraEffects() {
      ...
      this.glowBar.material.emissiveColor = new BABYLON.Color3.FromHexString(_Config__WEBPACK_IMPORTED_MODULE_2__["default"].palette[0]);
...
function () {
  function Grid(scene) {
    ...
    this.horizontalLinesInitialMax = _Config__WEBPACK_IMPORTED_MODULE_2__["default"].grid.horizontalLinesAmount;
    this.createGrid();
  }
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Grid, [{
    ...
    value: function createGrid() {
      // Horizontal Lines
      for (var i = 0; i < _Config__WEBPACK_IMPORTED_MODULE_2__["default"].grid.horizontalLinesAmount; i++) {
        this.newHorizontalLine(new BABYLON.Vector3(i * _Config__WEBPACK_IMPORTED_MODULE_2__["default"].grid.frequency, 0, i * _Config__WEBPACK_IMPORTED_MODULE_2__["default"].grid.frequency));
      }

      this.horizontalLines.forEach(function (line) {
        line.uniqueKey = "line-".concat(Math.round(Math.random() * 10000000));
      }); // Vertical Lines

      this.newVerticalLine(new BABYLON.Vector3(0, 0, 0));

      for (var _i = 0; _i < _Config__WEBPACK_IMPORTED_MODULE_2__["default"].grid.verticalLinesAmount / 2; _i++) {
        if (_i > 0) {
          this.newVerticalLine(new BABYLON.Vector3(_i * _Config__WEBPACK_IMPORTED_MODULE_2__["default"].grid.frequency, 0, 0));
        }
      }

      for (var _i2 = 0; _i2 < _Config__WEBPACK_IMPORTED_MODULE_2__["default"].grid.verticalLinesAmount / 2; _i2++) {
        if (_i2 > 0) {
          this.newVerticalLine(new BABYLON.Vector3(0, 0, _i2 * _Config__WEBPACK_IMPORTED_MODULE_2__["default"].grid.frequency));
        }
      }
    }
  }, {
    key: "newHorizontalLine",
    value: function newHorizontalLine(position) {
      this.horizontalLines.push(new BABYLON.MeshBuilder.CreateCylinder("grid-line", {
        diameter: _Config__WEBPACK_IMPORTED_MODULE_2__["default"].grid.diameter,
        height: _Config__WEBPACK_IMPORTED_MODULE_2__["default"].grid.height
      }, this.scene));
      ...
      this.horizontalLines.last().material.emissiveColor = _Config__WEBPACK_IMPORTED_MODULE_2__["default"].grid.color;
    }
  }, {
    key: "newVerticalLine",
    value: function newVerticalLine(position) {
      ...
      this.verticalLines.last().material.emissiveColor = _Config__WEBPACK_IMPORTED_MODULE_2__["default"].grid.color;
    }
  }, {
    key: "animate",
    value: function animate() {
      ...
      this.horizontalLines.forEach(function (line) {
        line.position.x += -_Config__WEBPACK_IMPORTED_MODULE_2__["default"].consciousness.walkSpeed;
        line.position.z += -_Config__WEBPACK_IMPORTED_MODULE_2__["default"].consciousness.walkSpeed;

        if (line.position.x <= sceneOriginOffset + _Config__WEBPACK_IMPORTED_MODULE_2__["default"].camera.initialTarget.diameter && line.position.z <= sceneOriginOffset + _Config__WEBPACK_IMPORTED_MODULE_2__["default"].camera.initialTarget.diameter && line.position.x >= sceneOriginOffset - _Config__WEBPACK_IMPORTED_MODULE_2__["default"].camera.initialTarget.diameter && line.position.z >= sceneOriginOffset - _Config__WEBPACK_IMPORTED_MODULE_2__["default"].camera.initialTarget.diameter) {
          line.material.emissiveColor = new BABYLON.Color3(1, 1, 1);
          line.dispose();

          _this.horizontalLines.splice(i, 1);

          _this.newHorizontalLine(new BABYLON.Vector3(_this.horizontalLinesInitialMax * _Config__WEBPACK_IMPORTED_MODULE_2__["default"].grid.frequency, 0, _this.horizontalLinesInitialMax * _Config__WEBPACK_IMPORTED_MODULE_2__["default"].grid.frequency));
        }
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Mountains, [{
    ...
    value: function createMountains() {
      ...
      _Config__WEBPACK_IMPORTED_MODULE_2__["default"].mountains.meshes.forEach(function (mountain) {
        var mesh = new BABYLON.Mesh.CreateGroundFromHeightMap("ground-".concat(Math.round(Math.random() * 100)), mountain.heightMap, mountain.width, mountain.height, mountain.subdivisions, 0, mountain.textureHeight, _this.scene, true);
...
/*#__PURE__*/
function () {
  function Plane(plane, scene, followCamera) {
    Object(_babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, Plane);
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Plane, [{
    key: "createPlane",
...
var Sky = function Sky(scene) {
  Object(_babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, Sky);
...
function () {
  function Stars(scene) {
    ...
    this.scene = scene;
    this.stars = [];
    this.createStars(_Config__WEBPACK_IMPORTED_MODULE_2__["default"].stars.amount, false);
  }

  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Stars, [{
    key: "createStars",
    value: function createStars(amount, fadeIn) {
      fadeIn = fadeIn || false;
      ...
      for (var i = 0; i < amount; i++) {
        var star = BABYLON.MeshBuilder.CreateBox("sphere", {
          size: getRandomMinMax(_Config__WEBPACK_IMPORTED_MODULE_2__["default"].stars.minSize, _Config__WEBPACK_IMPORTED_MODULE_2__["default"].stars.maxSize)
        }, this.scene);
    ...
    value: function animate() {
      ...
      this.stars.forEach(function (star) {
        star.position.x += -_Config__WEBPACK_IMPORTED_MODULE_2__["default"].consciousness.walkSpeed;
        star.position.z += -_Config__WEBPACK_IMPORTED_MODULE_2__["default"].consciousness.walkSpeed;
        star.rotation.x += _Config__WEBPACK_IMPORTED_MODULE_2__["default"].stars.rotationSpeed;
        star.rotation.z += _Config__WEBPACK_IMPORTED_MODULE_2__["default"].stars.rotationSpeed;
        star.rotation.y += _Config__WEBPACK_IMPORTED_MODULE_2__["default"].stars.rotationSpeed;

        if (star.material.alpha < 1) {
          star.material.alpha += _Config__WEBPACK_IMPORTED_MODULE_2__["default"].stars.fadeInSpeed;
        }
        ...
        if (star.position.x <= sceneOriginOffset && star.position.z <= sceneOriginOffset) {
          ...
          _this.stars.splice(i, 1);

          _this.createStars(1, true);
        }
...
function () {
  function Sun(scene) {
    Object(_babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, Sun);

    this.scene = scene;
    this.init();
  }

  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Sun, [{
    key: "init",
    value: function init() {
...
function () {
  function Title(scene) {
    ...
    this.scene = scene;
    this.scale = _Utils__WEBPACK_IMPORTED_MODULE_3__["default"].getProp("title", "scale");
    this.x = _Utils__WEBPACK_IMPORTED_MODULE_3__["default"].getProp("title", "x");
    this.y = _Utils__WEBPACK_IMPORTED_MODULE_3__["default"].getProp("title", "y");
    this.z = _Utils__WEBPACK_IMPORTED_MODULE_3__["default"].getProp("title", "z");
    this.rotationY = 0.75;
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Title, [{
    ...
    value: function createTitle() {
      ...
      this.text = new Writer(_Config__WEBPACK_IMPORTED_MODULE_2__["default"].title.text, {
        anchor: "center",
        "letter-height": 0.5,
        "letter-thickness": 0.1,
        colors: {
          emissive: _Config__WEBPACK_IMPORTED_MODULE_2__["default"].palette[0]
        },
        position: {
          z: this.z,
          x: this.x,
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  getProp: function getProp(key1, key2) {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _Config__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Config */ "./components/World/Config.js");
/* harmony import */ var _Mountains__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Mountains */ "./components/World/Mountains.js");
/* harmony import */ var _Camera__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Camera */ "./components/World/Camera.js");
/* harmony import */ var _Light__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./Light */ "./components/World/Light.js");
/* harmony import */ var _Utils__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./Utils */ "./components/World/Utils.js");
/* harmony import */ var _Effects__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./Effects */ "./components/World/Effects.js");
/* harmony import */ var _Stars__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./Stars */ "./components/World/Stars.js");
/* harmony import */ var _Backgrounds__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./Backgrounds */ "./components/World/Backgrounds.js");
/* harmony import */ var _Consciousness__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./Consciousness */ "./components/World/Consciousness.js");
/* harmony import */ var _Plane__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./Plane */ "./components/World/Plane.js");
/* harmony import */ var _Grid__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./Grid */ "./components/World/Grid.js");
...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(World, [{
    key: "resizeToMatchDisplaySize",
    value: function resizeToMatchDisplaySize(canvas) {
    ...
    value: function renderWorld() {
      ...
      if (_Config__WEBPACK_IMPORTED_MODULE_6__["default"].lights.enabled) {
        this.light = new _Light__WEBPACK_IMPORTED_MODULE_9__["default"](this.scene);
      }

      if (_Config__WEBPACK_IMPORTED_MODULE_6__["default"].grid.enabled) {
        this.grid = new _Grid__WEBPACK_IMPORTED_MODULE_16__["default"](this.scene);
      }
      ...
      if (_Config__WEBPACK_IMPORTED_MODULE_6__["default"].effects.enabled) {
        this.effects = new _Effects__WEBPACK_IMPORTED_MODULE_11__["default"](this);
      }

      if (_Config__WEBPACK_IMPORTED_MODULE_6__["default"].title.enabled) {
        this.title = new _Title__WEBPACK_IMPORTED_MODULE_17__["default"](this.scene);
      }

      _Config__WEBPACK_IMPORTED_MODULE_6__["default"].planes.forEach(function (plane) {
        if (plane.enabled) {
          plane.mesh = new _Plane__WEBPACK_IMPORTED_MODULE_15__["default"](plane, _this2.scene, plane.followCamera);
        }
      });
    }
  }, {
    ...
    value: function componentDidMount() {
      ...
      if (_Config__WEBPACK_IMPORTED_MODULE_6__["default"].debug.axis) {
        _Utils__WEBPACK_IMPORTED_MODULE_10__["default"].showWorldAxis(_Config__WEBPACK_IMPORTED_MODULE_6__["default"].debug.axisSize, this.scene);
      }

      if (_Config__WEBPACK_IMPORTED_MODULE_6__["default"].consciousness.enabled) {
        this.consciousness = new _Consciousness__WEBPACK_IMPORTED_MODULE_14__["default"](this);
      }
