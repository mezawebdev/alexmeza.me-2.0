  ...
  function DynamicGround(scene) {
    ...
    for (var l = 0; l < mapSubZ; l++) {
      for (var w = 0; w < mapSubX; w++) {
        mapData[1 * (l * mapSubX + w)] = (w - mapSubX * 0.5) * 1.0;
        mapData[1 * (l * mapSubX + w) + 1] = w / (l + 1) * Math.sin(l / 2) * Math.cos(w / 2) * 2.0;
        mapData[1 * (l * mapSubX + w) + 2] = (l - mapSubZ * 0.5) * 1.0;
      }
    }
...
//# sourceMappingURL=1.c4db3f880f82a2698bcf.hot-update.js.map